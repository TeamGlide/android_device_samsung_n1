...
void AkmSensor::processEvent(int code, int value)
{
    switch (code) {
        case EVENT_TYPE_ACCEL_X:
            ALOGV("AkmSensor: EVENT_TYPE_ACCEL_X value=%d", value);
            mPendingMask |= 1<<Accelerometer;
            mPendingEvents[Accelerometer].acceleration.x = value * CONVERT_A_X;
            break;
        case EVENT_TYPE_ACCEL_Y:
            ALOGV("AkmSensor: EVENT_TYPE_ACCEL_Y value=%d", value);
            mPendingMask |= 1<<Accelerometer;
            mPendingEvents[Accelerometer].acceleration.y = value * CONVERT_A_Y;
            break;
        case EVENT_TYPE_ACCEL_Z:
            ALOGV("AkmSensor: EVENT_TYPE_ACCEL_Z value=%d", value);
            mPendingMask |= 1<<Accelerometer;
        ...
        case EVENT_TYPE_YAW:
            ALOGV("AkmSensor: EVENT_TYPE_YAW (orient) value=%d", value);
            mPendingMask |= 1<<Orientation;
            mPendingEvents[Orientation].orientation.azimuth = value * CONVERT_O_A;
            break;
        case EVENT_TYPE_PITCH:
            ALOGV("AkmSensor: EVENT_TYPE_PITCH (orient) value=%d", value);
            mPendingMask |= 1<<Orientation;
            mPendingEvents[Orientation].orientation.pitch = value * CONVERT_O_P;
            break;
        case EVENT_TYPE_ROLL:
            ALOGV("AkmSensor: EVENT_TYPE_ROLL (orient) value=%d", value);
            mPendingMask |= 1<<Orientation;
            mPendingEvents[Orientation].orientation.roll = value * CONVERT_O_R;
            break;
        case EVENT_TYPE_ORIENT_STATUS:
            ALOGV("AkmSensor: EVENT_TYPE_ORIENT_STATUS value=0x%x", value);
